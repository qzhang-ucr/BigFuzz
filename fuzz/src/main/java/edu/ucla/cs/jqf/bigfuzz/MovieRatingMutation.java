...
//                numberAsString=numberAsString + str.charAt(number);
//            }
//
//
//            int insertPos = r.nextInt(rows.size());
//
//            int rate = r.nextInt(5);
//            numberAsString = numberAsString+": _"+Integer.toString(rate);
...
//            String[] columns = row.split(": _");
//            columns[1] = Integer.toString(r.nextInt(maxV-minV)+minV);
//            int insertPos = r.nextInt(rows.size());
//
...
//            {
//                insertRow = insertRow + ": _"+columns[j];
//            }
//
