...
public class Runner extends Logging {
    ...
    public static void main(String[] args) {
        String test_name = "ProvFuzzBenchmark";
        if (args.length >= 1) {
            test_name = args[0];
...
//            String conf_file = "/home/ahmad/Documents/VT/project1/BigFuzz/MatrixMinMaxNN.conf";
            String conf_file = "/home/ahmad/Documents/VT/project1/FineGrainedDataProvenance/src/main/scala/examples/benchmarks/exportable/"+test_name+".conf";
